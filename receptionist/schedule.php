        ...
        <?php else: // day ?>
            ...
            <?php else: ?>
                ...
                <?php if (empty($dentists)): ?>
                    <p style="font-size:.8rem;color:var(--text-gray);margin-top:1rem;">No active dentist accounts yet — ask an administrator to add one to see per-dentist availability here.</p>
                <?php endif; ?>
            <?php endif; ?>
        <?php endif; ?>
    </div>
